...
ln, exp, sin, cos, tan, sec, cosec, cot, sinh, cosh, tanh, sech, cosech and coth.
...
# sec, cosec, cot, sinh, cosh, tanh, sech, cosech, cothan or ln) and two operands,
# which are either constants or references to other trees.
# ########################################################################################
sub buildTree {
	...
	} elsif ($expr =~ /^ \(* (\-?) (sinh?|cosh?|tanh?|sech?|cosech?|coth?|ln|exp) \((.+)\) \)* $/x) {
